...
use App\Http\Controllers\UserSerieController;
use Illuminate\Support\Facades\Route;

// Get token para testes via postman
...
Route::middleware('auth:sanctum')->group(function () {
    ...
    // user-series routes - para marcar um filme como assistido por um usuário
    Route::post('/series/{id_serie}/users', [UserSerieController::class, 'store']);
    Route::delete('/series/{id_serie}/users', [UserSerieController::class, 'destroy']);
