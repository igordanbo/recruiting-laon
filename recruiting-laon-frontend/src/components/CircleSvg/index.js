     ...
     Z"
      ...
      {variant === "menu" && (
        ...
        >
          ...
          />
          <path
            d="M14 14.6666H26V16H14V14.6666ZM14 19.3333H26V20.6666H14V19.3333ZM14 24H26V25.3333H14V24Z"
            fill="white"
          />
        </svg>
      )}
      ...
      {variant === "search" && (
        ...
        >
          ...
          />
          <path
            d="M24.0206 23.0779L26.8757 25.933L25.9329 26.8758L23.0778 24.0207C22.0512 24.842 20.7493 25.3334 19.3333 25.3334C16.0213 25.3334 13.3333 22.6454 13.3333 19.3334C13.3333 16.0214 16.0213 13.3334 19.3333 13.3334C22.6453 13.3334 25.3333 16.0214 25.3333 19.3334C25.3333 20.7494 24.8419 22.0513 24.0206 23.0779ZM22.6831 22.5832C23.4983 21.7431 23.9999 20.5971 23.9999 19.3334C23.9999 16.755 21.9116 14.6667 19.3333 14.6667C16.7549 14.6667 14.6666 16.755 14.6666 19.3334C14.6666 21.9117 16.7549 24 19.3333 24C20.597 24 21.743 23.4984 22.5831 22.6832L22.6831 22.5832Z"
            fill="white"
          />
        </svg>
      )}
