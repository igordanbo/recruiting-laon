...
export default function UserOptions({
  ...
  return (
    <nav ref={ref} className={styles.nav_user_options + " " + adicionalClass}>
      <button onClick={onClickEdit} className={styles.nav_user_option}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <p className="lr_regular_16 text-white">Editar dados</p>
      </button>
      <button onClick={onClickList} className={styles.nav_user_option}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <p className="lr_regular_16 text-white">Sua lista</p>
      </button>
      <button onClick={onClickLogout} className={styles.nav_user_option}>
        <svg
          width="24"
          height="24"
          viewBox="0 0 24 24"
        ...
        <p className="lr_regular_16 text-white">Sair</p>
      </button>
    </nav>
  );
}
